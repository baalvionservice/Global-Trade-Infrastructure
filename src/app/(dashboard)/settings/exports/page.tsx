  ...
  return (
    <main className="flex-1 space-y-12 p-4 md:p-12 bg-muted/20 min-h-screen">
      <div className="space-y-1">
        <p className="text-[10px] font-black uppercase tracking-[0.4em] text-primary">Sovereign Portability</p>
      ...
      <div className="grid gap-10 lg:grid-cols-3">
        {[
          ...
          <Card key={exp.id} className="shadow-xl border-2 hover:border-primary/40 transition-all rounded-[32px] overflow-hidden group bg-background">
      ...
      <Card className="shadow-2xl border-none bg-slate-950 text-white relative overflow-hidden rounded-[40px] group">
         ...
         <CardContent className="p-16 relative z-10 space-y-8 max-w-3xl">
            <h4 className="text-[10px] font-black uppercase tracking-[0.5em] text-primary">Data Sovereignty Standard</h4>
