      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-primary/5 pb-12">
        <div className="space-y-4">
          <div className="flex items-center gap-3">
             ...
             <p className="text-[10px] font-black uppercase tracking-[0.5em] text-primary">Authority node: IDENTITY_ONBOARD_01</p>
          </div>
                       ...
                       <Card className="shadow-2xl border-2 hover:border-primary/40 transition-all rounded-[40px] overflow-hidden bg-background group">
                          <CardHeader className="bg-muted/10 border-b p-10 flex flex-row items-center justify-between">
                             <div className="flex items-center gap-6">
                                <div className="h-16 w-16 rounded-[24px] bg-background border-2 shadow-inner flex items-center justify-center group-hover:scale-105 transition-transform">
                          ...
                          <CardFooter className="p-8 pt-0 flex gap-4">
                             <Button 
                                variant="outline" 
                                className="flex-1 h-16 border-2 border-red-100 text-red-600 font-black uppercase text-[11px] tracking-widest hover:bg-red-50 rounded-2xl"
                             ...
                             <Button 
                                className="flex-1 h-16 bg-emerald-600 hover:bg-emerald-700 font-black uppercase text-[11px] tracking-widest shadow-2xl rounded-2xl"
        ...
        <div className="lg:col-span-4 space-y-12">
           ...
           <Card className="shadow-none border-2 bg-background p-10 space-y-12 rounded-[48px]">
              <div className="flex items-center justify-between">
                 <h4 className="text-[11px] font-black uppercase tracking-[0.4em] text-muted-foreground ml-1">Ecosystem Pipeline</h4>
