    ...
    <main className="flex-1 space-y-12 p-4 md:p-12 bg-muted/20 min-h-screen">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-primary/5 pb-10">
        <div className="space-y-1">
          <p className="text-[10px] font-black uppercase tracking-[0.4em] text-primary">Coordination Intelligence</p>
          <h2 className="text-4xl font-black tracking-tight uppercase tracking-tighter text-foreground leading-none">Collaboration Analytics</h2>
      ...
      <div className="grid gap-10 lg:grid-cols-12">
        <Card className="lg:col-span-8 shadow-none border-2 bg-background rounded-[40px] overflow-hidden flex flex-col h-[500px]">
        ...
        <div className="lg:col-span-4 space-y-10">
           <Card className="shadow-2xl border-none bg-primary text-primary-foreground relative overflow-hidden group rounded-[40px]">
              ...
              <CardContent className="p-10 relative space-y-12">
                 ...
                 <Button variant="secondary" className="w-full h-18 font-black uppercase text-[12px] tracking-[0.3em] shadow-3xl bg-white text-primary border-none rounded-3xl hover:scale-[1.02] transition-transform">
