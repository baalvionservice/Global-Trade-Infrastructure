  ...
  if (loading) {
    return (
      <div className="h-full flex flex-col items-center justify-center gap-6">
        ...
        <p className="text-[10px] font-black uppercase tracking-[0.5em] text-primary animate-pulse">Syncing Governance Vaults...</p>
      </div>
    );
  }
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b pb-12">
        <div className="space-y-4">
          <div className="flex items-center gap-3">
             ...
             <p className="text-[10px] font-black uppercase tracking-[0.5em] text-primary">Authority Node: ESCROW_GATE_PROB_V4</p>
          </div>
          <h2 className="text-6xl font-black tracking-tight uppercase tracking-tighter leading-[0.8]">Escrow <br />Governance.</h2>
        </div>
        ...
        <div className="lg:col-span-8 space-y-10">
           <div className="grid gap-8">
              {escrows.map((escrow, i) => (
                ...
                >
                  <Card className="shadow-xl border-2 hover:border-primary/40 transition-all rounded-[40px] overflow-hidden bg-background group">
                       ...
                       <div className="flex-1 p-10 flex flex-col md:flex-row items-center justify-between gap-10">
                          ...
                          <div className="flex flex-col items-end shrink-0 border-l-2 pl-12 border-muted/50 space-y-6">
                             <div className="text-right space-y-1">
                                ...
                                <p className="text-sm font-black text-primary uppercase tracking-tight">{escrow.releaseCondition.replace(/_/g, ' ')}</p>
                             </div>
        ...
        <div className="lg:col-span-4 space-y-12">
           ...
           <Card className="shadow-none border-2 bg-background p-10 space-y-12 rounded-[48px]">
              <div className="flex items-center justify-between">
                 <h4 className="text-[11px] font-black uppercase tracking-[0.4em] text-muted-foreground ml-1">Settlement Pulse</h4>
