  ...
  if (loading) {
    return (
      <div className="h-full flex flex-col items-center justify-center gap-6 bg-background">
        ...
        <p className="text-[10px] font-black uppercase tracking-[0.5em] text-muted-foreground animate-pulse">Synchronizing Risk Matrix...</p>
      </div>
    );
  }
    ...
    <main className="space-y-12 pb-24">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b pb-12">
        <div className="space-y-4">
          <div className="flex items-center gap-3">
             ...
             <p className="text-[10px] font-black uppercase tracking-[0.5em] text-red-500">Security Node: FINANCIAL_INTEGRITY_01</p>
          </div>
          <h2 className="text-6xl font-black tracking-tight uppercase tracking-tighter leading-[0.8]">Risk <br />Governance.</h2>
        </div>
        <div className="flex gap-4">
           <div className="flex items-center gap-3 px-8 py-3 bg-red-600 rounded-2xl border-2 border-red-500 font-black text-xs uppercase tracking-widest text-white shadow-4xl animate-pulse transition-all duration-700">
      ...
      <div className="grid gap-10 lg:grid-cols-12">
        <div className="lg:col-span-8 space-y-10">
           ...
           <Card className="shadow-none border-2 bg-background rounded-[48px] overflow-hidden flex flex-col h-[600px] relative group">
              ...
              <CardHeader className="bg-muted/10 border-b p-10 flex flex-row items-center justify-between z-10">
              ...
              <CardContent className="p-0 flex-1 flex items-center justify-center relative z-10">
                 <div className="relative text-center space-y-8">
                    ...
                    <div className="space-y-2">
                       <p className="text-[11px] font-black uppercase tracking-[0.5em] text-emerald-400">124 Node Clusters Scanned</p>
                 ...
                 <div className="divide-y-2">
                    {[
                      ...
                      { id: 'KYC-442', title: 'Identity Drift: Tier 2 Seller', type: 'IDENTITY_SYNC', impact: 'medium', severity: 'WARNING', status: 'AUDITING' },
                       ...
                       <div key={dispute.id} className="p-10 flex items-center justify-between group hover:bg-red-500/[0.01] transition-colors">
        ...
        <div className="lg:col-span-4 space-y-10">
           ...
           <Card className="shadow-none border-2 bg-background p-12 text-center space-y-8 rounded-[48px] border-dashed group hover:border-primary/20 transition-all duration-700">
              ...
              <div className="space-y-3">
                 <p className="text-sm font-black uppercase tracking-[0.3em] text-muted-foreground">Forensic Audit Replay</p>
