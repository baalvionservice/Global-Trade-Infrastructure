...
export default function RFQDetailPage() {
  ...
  if (loading) {
    return (
      <div className="flex h-[80vh] flex-col items-center justify-center gap-6 bg-background">
        ...
        <p className="text-[11px] font-black uppercase tracking-[0.5em] text-muted-foreground animate-pulse">Syncing Sourcing Context...</p>
      </div>
    );
  }
  ...
  return (
    <main className="flex-1 space-y-12 p-4 md:p-12 bg-muted/20 min-h-screen pb-32">
      {/* COMMAND HEADER */}
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-10">
        <div className="space-y-6">
          ...
          <div className="space-y-3">
             <div className="flex items-center gap-4">
                <p className="text-[10px] font-black uppercase tracking-[0.4em] text-primary">Sourcing Mandate</p>
                <Badge variant="outline" className="uppercase font-black text-[10px] px-4 py-1.5 border-2 shadow-sm rounded-full bg-background">
                  {rfq.id}
                </Badge>
             </div>
             <h2 className="text-5xl font-black tracking-tight text-foreground uppercase tracking-tighter leading-[0.9] max-w-4xl">
        ...
        <div className="flex flex-wrap gap-4 pt-10 md:pt-0">
          ...
          <Button 
            variant="destructive" 
            className="h-16 px-12 font-black uppercase tracking-widest text-xs shadow-3xl hover:scale-[1.02] transition-all"
      ...
      <div className="bg-slate-950 border-none rounded-[48px] p-16 shadow-4xl relative overflow-hidden ring-1 ring-white/10">
        ...
        <h3 className="text-[11px] font-black uppercase tracking-[0.5em] text-primary mb-16 text-center">Operational Lifecycle Pulse</h3>
        <RFQStatusTimeline status={rfq.status} />
      </div>

      <div className="grid gap-12 lg:grid-cols-12">
        <div className="lg:col-span-4 space-y-12">
           <Card className="shadow-none border-2 bg-background overflow-hidden rounded-[40px] flex flex-col">
              ...
              <CardContent className="p-12 space-y-12">
                <div className="space-y-8">
                   <div className="flex items-start gap-6 group cursor-default">
                      ...
                      <div>
                        <p className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.3em] mb-1">Volume Protocol</p>
                   ...
                   <div className="flex items-start gap-6 group cursor-default">
                      ...
                      <div>
                        <p className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.3em] mb-1">Destination Node</p>
                   ...
                   <div className="flex items-start gap-6 group cursor-default">
                      ...
                      <div>
                        <p className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.3em] mb-1">Floor Cap</p>
                ...
                <div className="p-8 bg-indigo-50 border-2 border-indigo-100 rounded-[32px] space-y-6 relative overflow-hidden group">
                   ...
                   <p className="text-[10px] font-black uppercase text-indigo-700 tracking-[0.4em]">Signal Intelligence</p>
           ...
           <Card className="shadow-none border-2 bg-background p-12 space-y-12 rounded-[40px]">
              <h4 className="text-[11px] font-black uppercase tracking-[0.4em] text-muted-foreground ml-1">Governance Audit</h4>
              ...
              <CardContent className="p-12 relative space-y-12">
                 ...
                 <div className="grid grid-cols-2 gap-10">
                    <div className="p-10 rounded-[32px] bg-white/10 border border-white/10 shadow-inner backdrop-blur-md">
                       ...
                       <p className="text-5xl font-black text-emerald-300 tabular-nums tracking-tighter">99.8%</p>
                    </div>
                    <div className="p-10 rounded-[32px] bg-white/10 border border-white/10 shadow-inner backdrop-blur-md">
                       <p className="text-[10px] font-black uppercase opacity-60 mb-2 text-white tracking-widest">Optimization Lift</p>
                       <p className="text-5xl font-black text-blue-300 tabular-nums tracking-tighter">+14%</p>
                    </div>
                 </div>
