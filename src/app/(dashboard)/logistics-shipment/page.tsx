    ...
    <main className="space-y-12 pb-24">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b pb-12">
        <div className="space-y-4">
          <div className="flex items-center gap-3">
             ...
             <p className="text-[10px] font-black uppercase tracking-[0.5em] text-primary">Authority Node: LOGISTICS_CONTROL_ALPHA</p>
          </div>
          <h2 className="text-6xl font-black tracking-tight uppercase tracking-tighter leading-[0.8]">Execution <br />Control Tower.</h2>
        </div>
        <div className="flex gap-4">
          ...
          <Button className="h-16 px-12 bg-primary text-white font-black uppercase tracking-widest text-xs shadow-3xl hover:scale-[1.02] transition-all" onClick={() => router.push(`${PATHS.LOGISTICS_SHIPMENT}/booking`)}>
      ...
      <div className="grid gap-10 lg:grid-cols-12">
        <div className="lg:col-span-8 space-y-10">
           ...
           <Card className="shadow-none border-2 bg-slate-950 rounded-[48px] overflow-hidden flex flex-col h-[600px] relative">
                 ...
                 <div className="divide-y-2">
                    {[
                      ...
                      { id: 'SHP-8812', status: 'CUSTOMS_CLEARANCE', origin: 'Ho Chi Minh', dest: 'Newark', eta: '2d', health: 62 },
                       ...
                       <div key={shp.id} className="p-10 flex items-center justify-between group hover:bg-primary/[0.01] transition-colors" onClick={() => router.push(`${PATHS.LOGISTICS_SHIPMENT}/${shp.id}`)}>
        ...
        <div className="lg:col-span-4 space-y-12">
           {/* EXCEPTION QUEUE */}
           <Card className="shadow-2xl border-none bg-red-600 text-white relative overflow-hidden group rounded-[48px]">
              ...
              <CardContent className="p-12 relative space-y-10">
                 <AnimatePresence mode="wait">
                    {exceptions.length > 0 ? (
                       <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
                          ...
                          <Button variant="secondary" className="w-full h-18 font-black uppercase text-[10px] tracking-[0.3em] shadow-3xl bg-white text-red-600 border-none rounded-2xl">
                       ...
                       <div className="py-20 text-center space-y-4">
                          ...
                          <p className="text-[10px] font-black uppercase tracking-[0.3em] opacity-60">Zero Systemic Disruptions</p>
                       </div>
                    )}
                 </AnimatePresence>
              </CardContent>
           ...
           <Card className="shadow-none border-2 bg-background p-10 space-y-12 rounded-[48px]">
              <div className="flex items-center justify-between">
                 <h4 className="text-[11px] font-black uppercase tracking-[0.4em] text-muted-foreground ml-1">Corridor Pulse</h4>
                 <div className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse" />
              </div>
           ...
           <Card className="shadow-none border-2 bg-background p-12 text-center space-y-6 rounded-[48px] border-dashed group hover:border-primary/20 transition-all cursor-pointer">
