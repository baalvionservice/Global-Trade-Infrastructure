    ...
    <main className="space-y-12 pb-24">
      ...
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-10">
        <div className="space-y-6">
          <Button variant="ghost" size="sm" onClick={() => router.push('/logistics-shipment')} className="-ml-4 text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground hover:bg-transparent hover:text-primary">
            <ChevronLeft className="mr-1.5 h-4 w-4" /> Back to Control Tower
          </Button>
          <div className="space-y-3">
             <div className="flex items-center gap-4">
                <p className="text-[10px] font-black uppercase tracking-[0.4em] text-primary">Mission Node</p>
                <Badge variant="outline" className="uppercase font-black text-[10px] px-4 py-1.5 border-2 shadow-sm rounded-full bg-background">
                  {shipment.id}
                </Badge>
             </div>
             <h2 className="text-5xl font-black tracking-tight text-foreground uppercase tracking-tighter leading-[0.9]">
        ...
        <div className="flex gap-4 pt-10 md:pt-0">
          <Button variant="outline" className="h-16 px-10 border-2 font-black uppercase tracking-widest text-xs bg-background shadow-md group" onClick={handlePredict} disabled={predicting}>
      ...
      <div className="grid gap-12 lg:grid-cols-12">
        <div className="lg:col-span-8 space-y-12">
           ...
           <Card className="shadow-2xl border-none bg-slate-950 text-slate-100 relative overflow-hidden rounded-[48px] h-[550px]">
              ...
              <CardContent className="h-full relative flex flex-col p-12">
                 <div className="flex justify-between items-start">
                    <div className="space-y-4">
                       <div className="flex items-center gap-3">
                          <div className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse" />
                          <span className="text-[11px] font-black uppercase tracking-[0.3em] text-emerald-400">Telemetry Stream: SECURE</span>
                       </div>
           ...
           {/* MILESTONE TIMELINE */}
           <Card className="shadow-none border-2 bg-background rounded-[40px] p-12">
              <h4 className="text-[11px] font-black uppercase tracking-[0.4em] text-muted-foreground mb-12 text-center">Execution Finality Sequence</h4>
              <div className="relative pl-10 space-y-12 before:absolute before:left-[19px] before:top-2 before:bottom-2 before:w-0.5 before:bg-muted">
        ...
        <div className="lg:col-span-4 space-y-12">
           ...
           <Card className="shadow-2xl border-none bg-primary text-primary-foreground relative overflow-hidden group rounded-[48px]">
              ...
              <CardHeader className="pb-6 border-b border-white/10 p-12 relative">
           ...
           <Card className="shadow-none border-2 bg-background p-12 space-y-10 rounded-[48px]">
              <div className="flex items-center justify-between">
                 <h4 className="text-[11px] font-black uppercase tracking-[0.4em] text-muted-foreground ml-1">Asset Metadata</h4>
                 <div className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse" />
              </div>
           ...
           <Card className="shadow-none border-2 bg-background p-12 text-center space-y-8 rounded-[48px] border-dashed group hover:border-primary/20 transition-all">
              ...
              <div className="space-y-3">
                 <p className="text-sm font-black uppercase tracking-[0.3em] text-muted-foreground">Digital Twin Replay</p>
              ...
              <Button variant="outline" className="w-full h-12 border-2 font-black uppercase text-[9px] tracking-[0.2em] bg-background">LAUNCH SIMULATION</Button>
           </Card>
        </div>
      </div>
    </main>
