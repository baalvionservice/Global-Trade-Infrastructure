...
export function DashboardHeader() {
  ...
  // Switching persona moves you into that persona's own console. Only god-view tiers
  // (sovereign / platform) may cross personas; every other authority is locked to its own surface.
