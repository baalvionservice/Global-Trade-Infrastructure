        ...
        <div className="lg:col-span-4 space-y-10">
           ...
           <Card className="shadow-none border-2 bg-background overflow-hidden rounded-[32px]">
              <CardHeader className="bg-muted/10 border-b py-10 px-12 flex flex-row items-center justify-between">
                <div>
                  <CardTitle className="text-xl font-black uppercase tracking-[0.2em]">Active Disruption Ledger</CardTitle>
                 ...
                 <div className="divide-y-2">
                    {[
                      ...
                      { id: 'DS-994', title: 'Customs Hold Escalation: Shenzhen', type: 'REGULATORY', delay: '+48h', severity: 'medium', time: '2h ago' }
                       ...
                       <div key={dispute.id} className="p-12 flex items-start gap-8 group hover:bg-red-500/[0.01] transition-colors">
                          <div className={cn(
                             "h-16 w-16 rounded-[24px] border-2 flex items-center justify-center shadow-inner shrink-0 group-hover:scale-105 transition-transform duration-500",
        ...
        <div className="lg:col-span-3 space-y-10">
           ...
           <Card className="shadow-2xl border-none bg-primary text-primary-foreground relative overflow-hidden group rounded-[40px]">
              ...
              <CardContent className="p-10 relative space-y-10">
                 ...
                 <Button variant="secondary" className="w-full h-20 font-black uppercase text-[11px] tracking-[0.4em] shadow-3xl bg-white text-primary border-none rounded-3xl hover:scale-[1.02] transition-transform">
           ...
           <Card className="shadow-none border-2 bg-background p-10 space-y-10 rounded-[40px]">
              <h4 className="text-[11px] font-black uppercase tracking-[0.4em] text-muted-foreground ml-1">Systemic Exposure</h4>
           ...
           <Card className="shadow-none border-2 bg-background p-12 text-center space-y-6 rounded-[40px] border-dashed group hover:border-primary/40 transition-all duration-700">
              ...
              <Button variant="outline" className="w-full h-12 border-2 font-black uppercase text-[9px] tracking-[0.2em] bg-background" onClick={() => router.push(PATHS.GOVERNANCE_SIMULATION)}>DEPLOY DIGITAL TWIN</Button>
           </Card>
        </div>
      </div>
    </main>
