  ...
  if (loading) {
    return (
      <div className="flex h-[80vh] flex-col items-center justify-center gap-6">
        ...
        <p className="text-[11px] font-black uppercase tracking-[0.5em] text-muted-foreground animate-pulse">Syncing Strategic Oracle...</p>
      </div>
    );
  }
  ...
  return (
    <main className="space-y-12 pb-24">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b pb-12">
        <div className="space-y-4">
          <div className="flex items-center gap-3">
             ...
             <p className="text-[10px] font-black uppercase tracking-[0.5em] text-primary">Authority Node: INTELLIGENCE_COMMAND_01</p>
          </div>
          <h2 className="text-6xl font-black tracking-tight uppercase tracking-tighter leading-[0.8]">Strategic <br />Intelligence.</h2>
        </div>
        <div className="flex gap-4">
           <Button variant="outline" className="h-16 px-10 border-2 font-black uppercase tracking-widest text-xs bg-background shadow-md hover:bg-muted transition-all" onClick={() => router.push(PATHS.MARITIME_INTEL)}>
              <Anchor className="mr-3 h-4 w-4" /> Maritime Assets
           </Button>
           <Button className="h-16 px-12 bg-primary text-white font-black uppercase tracking-widest text-xs shadow-3xl hover:scale-[1.02] transition-all" onClick={() => router.push(PATHS.GEOPOLITICAL_MONITORING)}>
      ...
      <div className="grid gap-10 lg:grid-cols-12">
        ...
        <Card className="lg:col-span-8 shadow-none border-2 bg-background rounded-[48px] overflow-hidden flex flex-col h-[600px]">
           ...
           <CardContent className="p-10 flex-1 grid md:grid-cols-2 gap-12">
              <div className="space-y-8">
                 <p className="text-[11px] font-black uppercase tracking-[0.4em] text-primary mb-2">Corridor Exposure Indices</p>
                 {[
              ...
              <div className="bg-muted/30 rounded-[32px] border-2 border-dashed flex items-center justify-center p-12 relative overflow-hidden group">
                 ...
                 <div className="text-center space-y-6 relative z-10">
                    <Compass className="h-16 w-16 text-primary mx-auto opacity-20 group-hover:rotate-45 transition-transform duration-700" />
                    <div className="space-y-1">
                       <p className="text-xs font-black uppercase tracking-[0.3em] text-muted-foreground">Spatial Discovery</p>
        ...
        <div className="lg:col-span-4 space-y-10">
           ...
           <Card className="shadow-none border-2 bg-background p-10 space-y-10 rounded-[48px]">
              <div className="flex items-center justify-between">
                 <h4 className="text-[11px] font-black uppercase tracking-[0.4em] text-muted-foreground ml-1">Maritime Pulse</h4>
                 <div className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse" />
              </div>
              <div className="space-y-8">
                 {congestion.map(item => (
      ...
      <Card className="shadow-none border-2 bg-background overflow-hidden rounded-[48px]">
        <CardHeader className="flex flex-row items-center justify-between border-b bg-muted/10 p-10">
          <div className="space-y-1">
            <CardTitle className="text-sm font-black uppercase tracking-[0.3em]">Institutional Signal Stream</CardTitle>
              ...
              <AnimatePresence>
                 {signals.map((sig, i) => (
                    <motion.div 
                      ...
                      className="p-12 flex items-start gap-10 group hover:bg-primary/[0.01] transition-colors"
                    >
                       <div className={cn(
                       ...
                       <div className="space-y-4 flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-10 pt-4 text-[10px] font-black uppercase text-muted-foreground/60 tracking-[0.2em]">
                       ...
                       <div className="flex flex-col items-end gap-6 shrink-0 border-l-2 pl-12 border-muted/50">
                          ...
                          <Button variant="ghost" size="icon" className="h-14 w-14 rounded-[20px] border-2 opacity-20 group-hover:opacity-100 group-hover:bg-primary group-hover:text-white transition-all">
