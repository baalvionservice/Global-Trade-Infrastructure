      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-primary/5 pb-12">
        <div className="space-y-4">
          <div className="flex items-center gap-3">
             ...
             <p className="text-[10px] font-black uppercase tracking-[0.5em] text-primary">Strategic Node: GLOBAL_SIGINT_01</p>
          </div>
          <h2 className="text-6xl font-black tracking-tight uppercase tracking-tighter leading-[0.8]">Market <br />Signals.</h2>
        </div>
      ...
      <div className="grid gap-12 lg:grid-cols-12">
        <div className="lg:col-span-8 space-y-10">
           ...
           <Card className="shadow-none border-2 bg-background overflow-hidden rounded-[40px]">
              <CardHeader className="bg-muted/10 border-b py-10 px-12 flex flex-row items-center justify-between">
                <div>
                  <CardTitle className="text-xl font-black uppercase tracking-[0.2em]">Autonomous Signal Stream</CardTitle>
                          ...
                          >
                             ...
                             <div className="flex flex-col items-end gap-6 shrink-0 border-l-2 pl-12 border-muted/50">
                                <div className="text-right space-y-1">
                                   ...
                                   <p className="text-5xl font-black tracking-tighter text-red-600 tabular-nums">{sig.impactScore}%</p>
                                </div>
        ...
        <div className="lg:col-span-4 space-y-12">
           ...
           <Card className="shadow-none border-2 bg-background p-10 space-y-12 rounded-[48px]">
              <h4 className="text-[11px] font-black uppercase tracking-[0.4em] text-muted-foreground ml-1">Systemic Vulnerability</h4>
