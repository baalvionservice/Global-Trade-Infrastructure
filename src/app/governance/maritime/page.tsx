    ...
    <main className="flex-1 space-y-12 p-4 md:p-12 bg-slate-950 text-slate-100 min-h-screen selection:bg-primary">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-white/10 pb-12">
        <div className="space-y-4">
          <div className="flex items-center gap-3">
             ...
             <p className="text-[10px] font-black uppercase tracking-[0.5em] text-primary">Authority Node: MARITIME_SIGINT_ALPHA</p>
          </div>
          <h2 className="text-6xl font-black tracking-tight uppercase tracking-tighter leading-[0.8]">Maritime <br />Command.</h2>
        </div>
      ...
      <div className="grid gap-10 lg:grid-cols-12">
        ...
        <div className="lg:col-span-8 space-y-10">
           <Card className="shadow-none border-none bg-slate-900/40 rounded-[48px] overflow-hidden flex flex-col h-[700px] relative group">
              ...
              <CardContent className="p-0 flex-1 overflow-auto custom-scrollbar z-10 font-mono">
                 <div className="divide-y divide-white/5">
                    {routes.map((route, i) => (
                       <div key={route.id} className="p-10 flex items-center justify-between group/row hover:bg-white/[0.01] transition-colors">
                          <div className="flex items-center gap-10 flex-1 min-w-0">
                             <div className="h-20 w-20 rounded-[32px] border-2 border-white/10 bg-slate-950 flex items-center justify-center shadow-inner group-hover/row:scale-105 transition-transform duration-500">
        ...
        <div className="lg:col-span-4 space-y-10">
           {/* RISK ZONE PANEL */}
           <Card className="shadow-4xl border-none bg-red-600 text-white relative overflow-hidden group rounded-[48px]">
              ...
              <CardHeader className="pb-6 border-b border-red-500 p-10 relative">
              ...
              <CardContent className="p-10 relative space-y-8">
                 {risks.map(risk => (
                    <div key={risk.id} className="p-6 rounded-[32px] bg-white/10 border border-white/20 backdrop-blur-md space-y-4">
           ...
           <Card className="shadow-none border-none bg-slate-900/40 p-12 space-y-12 rounded-[48px]">
              <div className="flex items-center justify-between">
                 <h4 className="text-[11px] font-black uppercase tracking-[0.4em] text-slate-500 ml-1">Planetary Pulse</h4>
           ...
           <Card className="shadow-none border-none bg-slate-900/30 p-12 text-center space-y-8 rounded-[48px] border-dashed border-white/5">
              <Waves className="h-16 w-16 mx-auto text-slate-700 opacity-20" />
              <div className="space-y-3">
                 <p className="text-sm font-black uppercase tracking-[0.3em] text-slate-400">Oceanic Replay</p>
              ...
              <Button variant="outline" className="w-full h-12 border-white/10 font-black uppercase text-[9px] tracking-[0.2em] bg-slate-900/50 hover:bg-slate-800 text-white">LAUNCH TRAJECTORY SIM</Button>
           </Card>
        </div>
      </div>
    </main>
