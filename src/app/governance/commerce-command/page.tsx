    ...
    <main className="flex-1 space-y-12 p-4 md:p-12 bg-muted/20 min-h-screen">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
        <div className="space-y-1">
          <p className="text-[10px] font-black uppercase tracking-[0.4em] text-primary">Strategic Growth</p>
      ...
      <div className="grid gap-10 lg:grid-cols-7">
        <div className="lg:col-span-4 space-y-10">
           ...
           <Card className="shadow-none border-2 bg-background overflow-hidden rounded-[32px]">
              <CardHeader className="bg-muted/10 border-b pb-8 px-10 flex flex-row items-center justify-between">
                <div>
                  <CardTitle className="text-sm font-black uppercase tracking-[0.2em]">Institutional Demand Velocity</CardTitle>
                ...
                <div className="grid grid-cols-2 gap-8">
                   {signals.map((sig) => (
                      <motion.div 
                        ...
                        className="p-8 rounded-[32px] border-2 bg-muted/5 space-y-6 group hover:border-primary/40 transition-all cursor-default"
                      >
                         ...
                         <div className="space-y-1">
                            ...
                            <p className="text-5xl font-black tracking-tighter text-foreground tabular-nums">{sig.surgeIntensity}%</p>
                         </div>
           ...
           <Card className="shadow-none border-2 bg-background overflow-hidden rounded-[32px]">
              <CardHeader className="bg-muted/10 border-b pb-8 px-10 flex flex-row items-center justify-between">
                 <div>
                    <CardTitle className="text-sm font-black uppercase tracking-[0.2em]">Trade Corridor Expansion Intelligence</CardTitle>
              ...
              <CardContent className="p-0">
                 <div className="divide-y-2">
                    {opportunities.map(opp => (
                       <div key={opp.id} className="p-10 flex items-center justify-between group hover:bg-primary/[0.01] transition-colors">
                          <div className="flex items-center gap-8">
                             <div className="h-14 w-14 rounded-[24px] bg-muted border-2 flex items-center justify-center shadow-inner group-hover:scale-110 transition-transform">
        ...
        <div className="lg:col-span-3 space-y-10">
           ...
           <Card className="shadow-none border-2 bg-background p-10 space-y-12 rounded-[40px]">
              <h4 className="text-[11px] font-black uppercase tracking-[0.4em] text-muted-foreground ml-1">Expansion Pulse</h4>
              {[
           ...
           <Card className="shadow-none border-2 bg-background p-12 text-center space-y-6 rounded-[40px] border-dashed group hover:border-primary/40 transition-all duration-700">
              ...
              <div className="space-y-2">
                 <p className="text-sm font-black uppercase tracking-[0.2em] text-foreground">Industrial Knowledge Graph</p>
