  ...
  if (loading && !stats) {
    return (
      <div className="flex h-[80vh] flex-col items-center justify-center gap-6 bg-slate-950">
        ...
        <p className="text-[11px] font-black uppercase tracking-[0.5em] text-primary animate-pulse">Establishing Singularity Link...</p>
      </div>
    );
  }
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-white/10 pb-12">
        <div className="space-y-4">
          <div className="flex items-center gap-3">
             ...
             <p className="text-[10px] font-black uppercase tracking-[0.5em] text-primary">Sovereign Data Fabric v4.2</p>
          </div>
          <h2 className="text-6xl font-black tracking-tight uppercase tracking-tighter leading-[0.8] text-white">Data Singularity.</h2>
        ...
        <div className="flex flex-wrap gap-4">
           <Button variant="outline" className="h-16 px-10 border-white/10 bg-white/5 font-black uppercase text-xs tracking-widest hover:bg-white/10 rounded-2xl">
              <Search className="mr-3 h-4 w-4" /> Resolve Entity Hash
           </Button>
           <Button className="h-16 px-12 bg-primary text-white font-black shadow-4xl hover:scale-105 transition-all rounded-2xl uppercase tracking-[0.2em] text-xs" asChild>
        ...
        <div className="lg:col-span-4 space-y-10">
           ...
           <Card className="shadow-none border-none bg-slate-900/30 p-12 text-center space-y-8 rounded-[48px] border-dashed border-white/5">
              ...
              <div className="space-y-3">
                 <p className="text-sm font-black uppercase tracking-[0.3em] text-slate-400">Lakehouse Topology</p>
              ...
              <Button variant="outline" className="w-full h-12 border-white/10 font-black uppercase text-[9px] tracking-[0.2em] bg-slate-900/50 hover:bg-slate-800">LAUNCH ANALYTICS WAREHOUSE</Button>
           </Card>
        </div>
      </div>
    </main>
