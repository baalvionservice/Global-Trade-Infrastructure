    ...
    <main className="flex-1 space-y-12 p-4 md:p-12 bg-muted/20 min-h-screen">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-primary/5 pb-12">
        <div className="space-y-4">
          <div className="flex items-center gap-3">
             ...
             <p className="text-[10px] font-black uppercase tracking-[0.5em] text-primary">Authority Node: COLLAB_COORD_01</p>
          </div>
          <h2 className="text-6xl font-black tracking-tight uppercase tracking-tighter leading-[0.8]">Strategic <br />Coordination.</h2>
        </div>
      ...
      <div className="grid gap-10 lg:grid-cols-12">
        <div className="lg:col-span-8 space-y-10">
           ...
           <Card className="shadow-none border-2 bg-background rounded-[48px] overflow-hidden flex flex-col">
                    ...
                    <AnimatePresence>
                       {workspaces.map((ws, i) => (
                          <motion.div 
                            ...
                            className="p-10 flex items-center justify-between group hover:bg-primary/[0.01] transition-colors"
                          >
                             <div className="flex items-center gap-10 flex-1 min-w-0">
                                <div className={cn(
                                   "h-20 w-20 rounded-[32px] border-2 flex items-center justify-center shadow-inner group-hover:scale-105 transition-transform duration-500",
                                ...
                                <div className="space-y-4 flex-1 min-w-0">
                                   ...
                                   <div className="flex items-center gap-8 pt-2">
                                      ...
                                      <span className="text-[10px] font-black uppercase text-muted-foreground/60 tracking-[0.2em]">{ws.activeUsers.length} COLLABORATORS</span>
                                   </div>
                                </div>
                             </div>
        ...
        <div className="lg:col-span-4 space-y-12">
           ...
           <Card className="shadow-2xl border-none bg-primary text-primary-foreground relative overflow-hidden group rounded-[48px]">
              ...
              <CardContent className="p-10 relative space-y-10">
                 <div className="space-y-6">
                    {presence.map(p => (
                       <div key={p.userId} className="flex items-center justify-between p-6 rounded-[32px] bg-white/10 border border-white/10 shadow-inner backdrop-blur-md transition-all hover:bg-white/20 cursor-default">
           ...
           <Card className="shadow-none border-2 bg-background p-10 space-y-12 rounded-[48px]">
              <div className="flex items-center justify-between">
                 <h4 className="text-[11px] font-black uppercase tracking-[0.4em] text-muted-foreground ml-1">Coordination Efficiency</h4>
                 <div className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse" />
              </div>
