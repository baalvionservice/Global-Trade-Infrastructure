  ...
  if (loading && threats.length === 0) {
    return (
      <div className="flex h-[80vh] flex-col items-center justify-center gap-6 bg-slate-950">
        ...
        <p className="text-[11px] font-black uppercase tracking-[0.5em] text-red-500 animate-pulse">Establishing Security Handshake...</p>
      </div>
    );
  }
  ...
  return (
    <main className="flex-1 space-y-12 bg-slate-950 text-slate-100 min-h-screen p-4 md:p-12 selection:bg-red-600">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-white/10 pb-12">
        <div className="space-y-4">
          <div className="flex items-center gap-3">
             ...
             <p className="text-[10px] font-black uppercase tracking-[0.5em] text-red-500">Service Node: SECURITY_OPS_ALPHA</p>
          </div>
          <h2 className="text-6xl font-black tracking-tight uppercase tracking-tighter leading-[0.8]">SOC <br />Control.</h2>
        ...
        <div className="flex flex-wrap gap-4">
           ...
           <Button className="h-16 px-12 bg-red-600 text-white font-black shadow-4xl hover:scale-105 transition-all rounded-2xl uppercase tracking-[0.2em] text-xs">
      ...
      <div className="grid gap-10 lg:grid-cols-12">
        ...
        <Card className="lg:col-span-8 shadow-none border-none bg-slate-900/40 rounded-[48px] overflow-hidden flex flex-col h-[700px] relative group">
                 ...
                 <AnimatePresence initial={false}>
                    {threats.map((threat, i) => (
                       <motion.div 
                         ...
                         className="p-10 flex items-start gap-10 group hover:bg-white/[0.01] transition-colors"
                       >
                          <div className={cn(
                          ...
                          <div className="space-y-4 flex-1 min-w-0">
                             ...
                             <div className="flex items-center gap-10 pt-2 text-[10px] font-black uppercase text-slate-500 tracking-[0.2em]">
        ...
        <div className="lg:col-span-4 space-y-10">
           {/* STRATEGIC ORACLE */}
           <Card className="shadow-4xl border-none bg-primary text-white relative overflow-hidden group rounded-[48px] h-[350px]">
           ...
           <Card className="shadow-none border-none bg-slate-900/40 p-12 space-y-12 rounded-[48px]">
              <div className="flex items-center justify-between">
                 <h4 className="text-[11px] font-black uppercase tracking-[0.5em] text-slate-500 ml-1">Adversary Matrix</h4>
           ...
           <Card className="shadow-none border-none bg-slate-900/30 p-12 text-center space-y-8 rounded-[48px] border-dashed border-white/5 group hover:border-red-500/20 transition-all duration-700">
              <Terminal className="h-16 w-16 mx-auto text-slate-700 opacity-20 group-hover:text-red-500 transition-all duration-700 group-hover:rotate-[-45deg]" />
              <div className="space-y-3">
                 <p className="text-sm font-black uppercase tracking-[0.3em] text-slate-300">Forensic Audit Replay</p>
              ...
              <Button variant="outline" className="w-full h-12 border-white/10 font-black uppercase text-[9px] tracking-[0.2em] bg-slate-900/50 hover:bg-slate-800 text-white">OPEN EVIDENCE VAULT</Button>
           </Card>
        </div>
      </div>
    </main>
