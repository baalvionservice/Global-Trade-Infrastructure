      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b pb-12">
        <div className="space-y-4">
          <div className="flex items-center gap-3">
             ...
             <p className="text-[10px] font-black uppercase tracking-[0.5em] text-primary">Authority Node: UX_GOVERNANCE_ALPHA</p>
          </div>
          <h2 className="text-6xl font-black tracking-tight uppercase tracking-tighter leading-[0.8]">Design <br />Command.</h2>
          ...
          <motion.div key={s.label} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.1 }}>
             <Card className="shadow-lg border-2 border-primary/5 bg-background rounded-[32px] group hover:border-primary/20 transition-all">
                <CardHeader className="flex flex-row items-center justify-between pb-2 p-8 space-y-0">
                  <CardTitle className="text-[10px] font-black uppercase text-muted-foreground tracking-[0.3em]">{s.label}</CardTitle>
        ...
        <div className="lg:col-span-8 space-y-10">
           <Card className="shadow-none border-2 bg-background rounded-[48px] overflow-hidden flex flex-col">
              ...
              <CardContent className="p-10 space-y-12">
                 <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {(['compact', 'standard', 'executive'] as DensityMode[]).map((mode) => (
                       <button
                         ...
                         className={cn(
                           "p-10 rounded-[32px] border-2 flex flex-col items-center gap-6 transition-all group relative overflow-hidden",
                 ...
                 <div className="p-10 bg-muted/20 rounded-[32px] border-2 border-dashed border-primary/10 space-y-8">
                    <p className="text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground">Interactive Token Preview</p>
        ...
        <div className="lg:col-span-4 space-y-12">
           ...
           <Card className="shadow-none border-2 bg-background p-10 space-y-12 rounded-[48px]">
              <div className="flex items-center justify-between">
                 <h4 className="text-[11px] font-black uppercase tracking-[0.4em] text-muted-foreground ml-1">Motion Intelligence</h4>
