      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-white/10 pb-12">
        <div className="space-y-4">
          <div className="flex items-center gap-3">
             ...
             <p className="text-[10px] font-black uppercase tracking-[0.5em] text-primary">Intelligence Hub: MEMORY_FABRIC_01</p>
          </div>
          <h2 className="text-6xl font-black tracking-tight uppercase tracking-tighter leading-[0.8]">Semantic <br />Memory.</h2>
        ...
        <div className="lg:col-span-8 space-y-10">
           <div className="relative group">
              ...
              <input 
                ...
                className="w-full h-20 pl-16 pr-8 bg-white/5 border-2 border-white/10 rounded-[32px] text-xl font-black uppercase tracking-tight placeholder:text-slate-700 text-white focus:outline-none focus:border-primary/40 transition-all shadow-inner"
                value={search}
           ...
           <div className="grid gap-8">
              <AnimatePresence mode="popLayout">
                 {memories.map((mem, i) => (
                    ...
                    >
                       <Card className="shadow-2xl border-none bg-slate-900/60 rounded-[40px] overflow-hidden group hover:bg-white/[0.02] transition-all">
                          <CardContent className="p-0 flex">
                             ...
                             <div className="flex-1 p-10 flex flex-col md:flex-row items-center justify-between gap-12">
                                <div className="space-y-6 flex-1 min-w-0">
                                   ...
                                   <div className="flex items-center gap-8 pt-2 text-[10px] font-black uppercase text-slate-500 tracking-[0.3em]">
        ...
        <div className="lg:col-span-4 space-y-12">
           ...
           <Card className="shadow-none border-none bg-slate-900/40 p-12 space-y-12 rounded-[48px]">
              <div className="flex items-center justify-between">
                 <h4 className="text-[11px] font-black uppercase tracking-[0.5em] text-slate-500 ml-1">Memory finality</h4>
           ...
           <Card className="shadow-none border-none bg-slate-900/30 p-16 text-center space-y-10 rounded-[48px] border-dashed border-white/5">
              <Link2 className="h-16 w-16 mx-auto text-slate-700 opacity-20 group-hover:text-primary transition-all duration-700 group-hover:rotate-45" />
              <div className="space-y-4">
                 <p className="text-sm font-black uppercase tracking-[0.3em] text-slate-400">Inter-Node Sync</p>
