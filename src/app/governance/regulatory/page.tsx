    ...
    <main className="flex-1 space-y-12 p-4 md:p-12 bg-muted/20 min-h-screen">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-primary/5 pb-10">
        <div className="space-y-4">
          <Button variant="ghost" size="sm" onClick={() => router.push(PATHS.INTELLIGENCE_HUB)} className="-ml-4 text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground hover:bg-transparent hover:text-primary transition-all">
            <ChevronLeft className="mr-1.5 h-4 w-4" /> Back to command hub
          </Button>
          <div className="space-y-1">
            <p className="text-[10px] font-black uppercase tracking-[0.4em] text-primary">Sovereign SIGINT Hub</p>
      ...
      <div className="grid gap-12 lg:grid-cols-12">
        <div className="lg:col-span-8 space-y-10">
           ...
           <Card className="shadow-none border-2 bg-background overflow-hidden rounded-[40px]">
              <CardHeader className="bg-muted/10 border-b py-10 px-12 flex flex-row items-center justify-between">
                <div>
                  <CardTitle className="text-xl font-black uppercase tracking-[0.2em]">Autonomous Sanctions Stream</CardTitle>
                    ...
                    <AnimatePresence>
                       {signals.map((sig, i) => (
                          <motion.div 
                            ...
                            className="p-12 flex items-start gap-10 group hover:bg-red-500/[0.01] transition-colors"
                          >
                             <div className={cn(
                             ...
                             <div className="flex flex-col items-end gap-6 shrink-0 border-l-2 pl-12 border-muted/50">
                                <div className="text-right space-y-1">
                                   ...
                                   <p className="text-5xl font-black tracking-tighter text-red-600 tabular-nums">{Math.round(sig.matchConfidence * 100)}%</p>
                                </div>
        ...
        <div className="lg:col-span-4 space-y-12">
           ...
           <Card className="shadow-none border-2 bg-background p-10 space-y-12 rounded-[48px]">
              <div className="flex items-center justify-between">
                 <h4 className="text-[11px] font-black uppercase tracking-[0.4em] text-muted-foreground ml-1">Ecosystem finality</h4>
