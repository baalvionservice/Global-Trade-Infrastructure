      ...
      <div className="grid gap-10 lg:grid-cols-7">
        <div className="lg:col-span-4 space-y-10">
           ...
           <Card className="shadow-none border-2 bg-background overflow-hidden rounded-[32px]">
              <CardHeader className="bg-muted/10 border-b py-8 px-10 flex flex-row items-center justify-between">
                <div>
                  <CardTitle className="text-sm font-black uppercase tracking-[0.2em]">Institutional Retention Matrix</CardTitle>
                 ...
                 <div className="divide-y-2">
                    {[
                      ...
                      { category: 'Logistics Telemetry', window: '2 Years', status: 'ARCHIVING', volume: '12.8 TB' }
                       ...
                       <div key={i} className="p-10 flex items-center justify-between group hover:bg-primary/[0.01] transition-colors">
        ...
        <div className="lg:col-span-3 space-y-10">
           ...
           <Card className="shadow-2xl border-none bg-primary text-primary-foreground relative overflow-hidden group rounded-[32px]">
              ...
              <CardContent className="p-10 relative space-y-10">
                 ...
                 <div className="grid grid-cols-2 gap-4">
                    <div className="p-5 rounded-[24px] bg-white/10 border border-white/10 shadow-inner backdrop-blur-md">
                    ...
                    <div className="flex items-center justify-between p-5 rounded-[24px] bg-white/10 border border-white/10 shadow-inner backdrop-blur-md">
           ...
           <Card className="shadow-none border-2 bg-background p-10 space-y-10 rounded-[32px]">
              <h4 className="text-[11px] font-black uppercase tracking-[0.4em] text-muted-foreground ml-1">Ecosystem Telemetry</h4>
           ...
           <Card className="shadow-none border-2 bg-background p-12 text-center space-y-6 rounded-[32px] border-dashed group hover:border-primary/20 transition-all cursor-pointer">
