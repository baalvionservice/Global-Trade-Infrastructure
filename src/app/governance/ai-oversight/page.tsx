  ...
  if (loading) {
    return (
      <div className="flex h-[80vh] flex-col items-center justify-center gap-6 bg-slate-950">
        ...
        <p className="text-[11px] font-black uppercase tracking-[0.5em] text-primary animate-pulse">Establishing Governance Handshake...</p>
      </div>
    );
  }
    ...
    <main className="flex-1 space-y-12 p-4 md:p-12 bg-slate-950 text-slate-100 min-h-screen selection:bg-primary">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-white/10 pb-12">
        <div className="space-y-4">
          <div className="flex items-center gap-3">
             ...
             <p className="text-[10px] font-black uppercase tracking-[0.5em] text-primary">Authority Node: ORACLE_GOV_CENTER</p>
          </div>
          <h2 className="text-6xl font-black tracking-tight uppercase tracking-tighter leading-[0.8]">AI <br />Governance.</h2>
        ...
        <div className="flex gap-4">
           <Button variant="outline" className="h-16 px-8 border-white/10 bg-white/5 text-white font-black uppercase text-xs tracking-widest hover:bg-white/10 rounded-2xl">
      ...
      <div className="grid gap-10 lg:grid-cols-12">
        <div className="lg:col-span-8 space-y-10">
           {/* COHERENCE PULSE */}
           <Card className="shadow-none border-none bg-slate-900/40 rounded-[48px] overflow-hidden flex flex-col h-[500px] relative group">
              ...
              <CardContent className="p-12 flex-1 flex items-center justify-center relative z-10">
           ...
           <Card className="shadow-none border-none bg-slate-900/60 rounded-[32px] overflow-hidden">
        ...
        <div className="lg:col-span-4 space-y-10">
           ...
           <Card className="shadow-none border-none bg-slate-900/40 p-12 text-center space-y-8 rounded-[48px] border-dashed border-white/5 group hover:border-red-500/20 transition-all duration-700">
              <Siren className="h-16 w-16 mx-auto text-slate-700 opacity-20 group-hover:text-red-500 transition-all duration-700" />
              <div className="space-y-3">
                 <p className="text-sm font-black uppercase tracking-[0.3em] text-slate-300">Liability Kill-Switch</p>
              ...
              <Button variant="outline" className="w-full h-12 border-white/10 font-black uppercase text-[9px] tracking-[0.2em] bg-slate-900/50 hover:bg-slate-800">ARM KILL-SWITCH</Button>
           </Card>

           <Card className="shadow-none border-none bg-slate-900/40 p-10 space-y-10 rounded-[48px]">
              <div className="flex items-center justify-between">
                 <h4 className="text-[11px] font-black uppercase tracking-[0.5em] text-slate-500 ml-1">Explainability Metrics</h4>
