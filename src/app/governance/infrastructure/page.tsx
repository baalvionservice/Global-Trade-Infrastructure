  ...
  if (loading && nodes.length === 0) {
    return (
      <div className="flex h-[80vh] flex-col items-center justify-center gap-6 bg-slate-950">
        ...
        <p className="text-[11px] font-black uppercase tracking-[0.5em] text-primary animate-pulse">Establishing Infrastructure Handshake...</p>
      </div>
    );
  }

  return (
    <main className="flex-1 space-y-12 bg-slate-950 text-slate-100 min-h-screen p-4 md:p-12 selection:bg-primary selection:text-white">
      {/* HEADER */}
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-white/10 pb-12">
        <div className="space-y-4">
          <div className="flex items-center gap-3">
             <div className="h-2 w-2 rounded-full bg-emerald-500 animate-ping" />
             <p className="text-[10px] font-black uppercase tracking-[0.5em] text-primary">Service Node: INFRA_CORE_ALPHA</p>
          </div>
          <h2 className="text-6xl font-black tracking-tight uppercase tracking-tighter leading-[0.8]">Infra Command.</h2>
      ...
      <div className="grid gap-10 lg:grid-cols-12">
        ...
        <Card className="lg:col-span-8 shadow-none border-none bg-slate-900/40 rounded-[48px] overflow-hidden flex flex-col h-[700px] relative">
              ...
              <div className="divide-y divide-white/5">
                 {nodes.map((node, i) => (
                    <motion.div 
                      ...
                      className="p-10 flex items-center justify-between group hover:bg-white/[0.02] transition-all"
                    >
                       <div className="flex items-center gap-10 flex-1 min-w-0">
                          <div className={cn(
                             "h-16 w-16 rounded-[24px] border-2 flex items-center justify-center shadow-inner group-hover:scale-105 transition-transform duration-500",
                          ...
                          <div className="space-y-2 flex-1 min-w-0">
                             ...
                             <div className="flex items-center gap-10 text-[10px] font-black uppercase text-slate-500 tracking-[0.2em]">
        ...
        <div className="lg:col-span-4 space-y-10">
           ...
           <Card className="shadow-none border-none bg-slate-900/30 p-12 text-center space-y-8 rounded-[48px] border-dashed border-white/5 group hover:border-primary/20 transition-all">
              <Dna className="h-16 w-16 mx-auto text-slate-700 opacity-20 group-hover:text-primary transition-all duration-700 group-hover:rotate-45" />
              <div className="space-y-3">
                 <p className="text-sm font-black uppercase tracking-[0.3em] text-slate-400">GitOps Lifecycle</p>
              ...
              <Button variant="outline" className="w-full h-12 border-white/10 font-black uppercase text-[9px] tracking-[0.2em] bg-slate-900/50 hover:bg-slate-800 text-white">RECONSTRUCT FROM GIT</Button>
           </Card>
        </div>
      </div>
    </main>
