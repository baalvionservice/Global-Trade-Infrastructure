    ...
    <main className="flex-1 space-y-12 p-4 md:p-12 bg-muted/20 min-h-screen">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
        <div className="space-y-1">
           <p className="text-[10px] font-black uppercase tracking-[0.4em] text-primary">Authority Node: NATIONAL_TRADE_COMMAND</p>
        ...
        <div className="flex items-center gap-4">
           ...
           <Button className="font-black shadow-2xl h-14 px-12 text-[10px] uppercase tracking-widest hover:scale-105 transition-transform bg-primary">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        {[
          ...
          <Card key={stat.title} className="shadow-lg border-2 border-primary/5 bg-background hover:border-primary/20 transition-all rounded-[24px] group">
      ...
      <div className="grid gap-10 lg:grid-cols-7">
        <Card className="lg:col-span-4 shadow-none border-2 bg-background overflow-hidden flex flex-col h-full rounded-[32px]">
          <CardHeader className="bg-muted/10 border-b pb-8 px-10 flex flex-row items-center justify-between">
            <div>
              <CardTitle className="text-sm font-black uppercase tracking-[0.2em]">National Trade Velocity</CardTitle>
          ...
          <CardContent className="pt-12 px-10 h-[450px]">
        ...
        <div className="lg:col-span-3 space-y-10">
           <Card className="shadow-2xl border-none bg-primary text-primary-foreground relative overflow-hidden group rounded-[32px]">
              ...
              <CardContent className="p-10 relative space-y-12">
                 ...
                 <div className="space-y-5">
                    <div className="flex items-center justify-between p-5 rounded-[24px] bg-white/10 border border-white/10 shadow-inner">
           ...
           <Card className="shadow-none border-2 bg-background overflow-hidden flex flex-col rounded-[32px]">
              <CardHeader className="bg-muted/10 border-b py-6 px-10 flex flex-row items-center justify-between">
                 <CardTitle className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground">Trade Lane Health Index</CardTitle>
