...
const NAV_TRADE_CORE = [
  ...
  '/negotiations', '/messages', '/orders', '/trade-management',
...
const NAV_COMPLIANCE = [
  ...
  '/governance/regulatory', '/compliance', '/compliance-regulatory',
...
export const PERSONAS: PersonaDef[] = [
  ...
  // ============ TRADE PARTICIPANTS ============
  {
    ...
    nav: [
      ...
      '/orders', '/logistics-shipment', '/shipments', '/customs',
      '/payments', '/escrow', '/financials/invoices', '/insurance',
      '/compliance', '/documents', '/intelligence-hub', '/profile',
    ],
  },
  {
    ...
    nav: [
      ...
      '/marketplace', '/deals', '/negotiations', '/messages', '/orders',
      '/logistics-shipment', '/shipments', '/carriers', '/customs',
      '/payments', '/escrow', '/financials/invoices', '/insurance',
      '/compliance', '/documents', '/intelligence-hub', '/profile',
    ],
  ...
  },
  {
    ...
    nav: [
      ...
      '/compliance-regulatory/hs-codes', '/shipments', '/logistics-shipment',
      '/governance/audit-logs', '/documents', '/profile',
    ],
  },
  {
...
/** Fallback persona for any role not explicitly mapped (defensive — keeps the shell usable). */
